...
public class LinkedHashMapAdapter<K, V> extends BaseAdapter implements Filterable {
     ...
     * @param resource The resource ID for a webview file containing a TextView to use when
     *                 instantiating views.
     */
     ...
     *
     * @param context            The current context.
     * @param resource           The resource ID for a webview file containing a webview to use when
     *                           instantiating views.
     * @param textViewResourceId The id of the TextView within the webview resource to be populated
     * @param flags
     */
    ...
    private View createViewFromResource(int position, View convertView, ViewGroup parent,
        ...
        try {
            if (mFieldId == 0) {
                ...
                //  Otherwise, find the TextView field within the webview
    ...
    /**
     * <p>Sets the webview resource to create the drop down views.</p>
     *
     * @param resource the webview resource defining the drop down views
