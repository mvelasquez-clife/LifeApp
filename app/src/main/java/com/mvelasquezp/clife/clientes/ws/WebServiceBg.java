package com.mvelasquezp.clife.clientes.ws;
 ...
 *
 */
public class WebServiceBg extends AsyncTask<String, Long, String> {
	 ...
	 */
	public WebServiceBg(String urlWebService, Map<String, String> data, Context activity, Asynchtask callback) {
